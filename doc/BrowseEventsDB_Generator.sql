...
START TRANSACTION;
USE `BrowseEventsDB`;
INSERT INTO `User` (`idUsers`, `Username`, `Password`, `Email`, `FirstName`, `LastName`, `UserType_idUserType`, `VerificationCode`, `EmailStatus`, `LastLoginDate`) VALUES (1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'infobrowseevents@gmail.com', 'Admin', 'Admin', 1, NULL, 'verified', NULL);
